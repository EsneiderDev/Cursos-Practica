...
import { buscarHeroeVideo4  } from './js/callbacks'; // Video 4
import  { buscarHeroe as buscarHeroeCallback } from './js/callbacks'; // Video 5 y 6
 import { buscarHeroePromise } from './js/promesas';  // Video 7
